...
// GetGroupByMailNickName provides a mock function with given fields: ctx, slug
func (_m *MockClient) GetGroupByMailNickName(ctx context.Context, slug string) (*Group, error) {
