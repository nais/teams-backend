...
// GetDefaultTeamPurpose Get a default team purpose
func GetDefaultTeamPurpose() string {
	return fmt.Sprintf("auto-generated by nais console on %s", time.Now().Format(time.RFC1123Z))
}
