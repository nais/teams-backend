...
func (_m *MockAuditLogger) Logf(ctx context.Context, action sqlc.AuditAction, correlationID uuid.UUID, systemName sqlc.SystemName, actorEmail *string, targetTeamSlug *slug.Slug, targetUserEmail *string, message string, messageArgs ...interface{}) error {
	var _ca []interface{}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, sqlc.AuditAction, uuid.UUID, sqlc.SystemName, *string, *slug.Slug, *string, string, ...interface{}) error); ok {
