...
func (_m *MockAuditLogger) Logf(action string, corr dbmodels.Correlation, targetSystem dbmodels.System, actor *dbmodels.User, targetTeam *dbmodels.Team, targetUser *dbmodels.User, message string, messageArgs ...interface{}) error {
	var _ca []interface{}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, dbmodels.Correlation, dbmodels.System, *dbmodels.User, *dbmodels.Team, *dbmodels.User, string, ...interface{}) error); ok {
...
type NewMockAuditLoggerT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockAuditLogger(t NewMockAuditLoggerT) *MockAuditLogger {
