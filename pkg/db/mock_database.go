...
// AddUserRole provides a mock function with given fields: ctx, userID, roleName
func (_m *MockDatabase) AddUserRole(ctx context.Context, userID uuid.UUID, roleName sqlc.RoleName) error {
