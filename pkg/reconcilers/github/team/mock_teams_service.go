...
// NewMockTeamsService creates a new instance of MockTeamsService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockTeamsService(t testing.TB) *MockTeamsService {
