...
UPDATE reconcilers SET run_order = 1 WHERE name = 'github:team';
UPDATE reconcilers SET run_order = 2 WHERE name = 'azure:group';
UPDATE reconcilers SET run_order = 3 WHERE name = 'google:workspace-admin';
UPDATE reconcilers SET run_order = 4 WHERE name = 'google:gcp:project';
UPDATE reconcilers SET run_order = 5 WHERE name = 'nais:namespace';
